...
export type SanityArticle = SANITY_ARTICLES_QUERY_RESULT[number];

/** Convert a projected Sanity document into the source-neutral article contract. */
export function mapSanityArticle(document: SanityArticle): ArticleEntry {
